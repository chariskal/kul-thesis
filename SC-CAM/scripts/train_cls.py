...
if __name__ == '__main__':
    ...
    parser.add_argument("--voc12_root", default="/", type=str, help="the path to the dataset folder")
    ...
    parser.add_argument("--save_folder", required=True, default="./results_voc", type=str, help="the path to save the model")
    parser.add_argument("--snapshot_dir", default="checkpoints/train", type=str)
    ...
    for ep in range(args.max_epoches):
        ...
        if ep % 10 == 0:
            torch.save(model.module.state_dict(), '{}/weight/k{}_R{}_'.format(args.snapshot_dir, args.k_cluster, args.round_nb) + args.session_name + '_ep{}.pth'.format(ep))
