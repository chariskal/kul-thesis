...
class KvasirAffDataset(KvasirImageDataset):

    def __init__(self, img_name_list_path, label_la_dir, label_ha_dir, cropsize, dataset_root, radius=5,
...
class KvasirAffGtDataset(KvasirImageDataset):

    def __init__(self, img_name_list_path, label_dir, cropsize, dataset_root, radius=5,
                 joint_transform_list=None, img_transform_list=None, label_transform_list=None):
        super().__init__(img_name_list_path, dataset_root, transform=None)
