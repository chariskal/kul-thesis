...
if __name__ == '__main__':
    ...
    parser.add_argument("--list", default='./VOC2012/ImageSets/Segmentation/train.txt', type=str)       # list of set img names
    parser.add_argument("--predict_dir", default='./out_rw', type=str)                                  # cam directory
    parser.add_argument("--gt_dir", default='./VOC2012/SegmentationClass', type=str)                    # ground truth directory
    parser.add_argument('--logfile', default='./evallog.txt',type=str)                                  # save log file
    parser.add_argument('--comment', required=True, type=str)                                           # requires a comment ?
    parser.add_argument('--type', default='png', choices=['npy', 'png'], type=str)                      # type of image to save
    parser.add_argument('--t', default=None, type=float)                                                # ?
    parser.add_argument('--curve', default=False, type=bool)                                            # calculate curve or not
