...
from tools.ai.log_utils import Average_Meter, log_print
from tools.ai.optim_utils import PolyOptimizer
from tools.ai.torch_utils import set_seed, calculate_parameters, get_learning_rate_from_optimizer, load_model, save_model
from core.aff_utils import PathIndex
from tools.ai.augment_utils import RandomCrop_For_Segmentation, RandomHorizontalFlip_For_Segmentation, RandomResize_For_Segmentation, Resize_For_Mask, Normalize, Normalize_For_Segmentation, Transpose_For_Segmentation
...
if __name__ == '__main__':
    ...
    data_dir_new = create_directory(f'./experiments/data/')
    model_dir = create_directory('./experiments/models/')
    tensorboard_dir = create_directory(f'./experiments/tensorboards/{args.tag}/')
    
    log_path = log_dir + f'{args.tag}.txt'
    data_path = data_dir_new + f'{args.tag}.json'
